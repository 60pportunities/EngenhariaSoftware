Use o FORMS de Mensagens para definir as informações da sua mensagem. Você pode incluir tokens variáveis no texto da sua mensagem ao definir suas mensagens.
